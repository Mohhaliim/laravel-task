...
use App\Http\Controllers\NFCDetailsController;
use App\Http\Controllers\ListMailController;
...
Route::get('/track-shipment', [ShipmentTrackingController::class, 'showTrackingForm'])->name('track.shipment.form');
Route::post('/track-shipment', [ShipmentTrackingController::class, 'trackShipment'])->name('track.shipment');

//nfc details api
Route::get('/nfc', [NFCDetailsController::class, 'showNFCDetailsForm'])->name('nfc.details.form');
Route::post('/nfc', [NFCDetailsController::class, 'storeNFCDetails'])->name('nfc.details');
...
Route::middleware('auth', 'valid.user')->group(function () {
    ...
    Route::prefix('sadmin')->middleware('role:super_admin')->group(function () {
        ...
        Route::get('/list-mail', [ListMailController::class, 'index'])->name('list.mail.index');
