@role(App\Models\Role::ROLE_SUPER_ADMIN)
    ...
    <li
    class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('sadmin/send*','sadmin/list-mail*') ? 'd-none' : '' }}">
    <a class="nav-link p-0 {{ Request::is('sadmin/send*') ? 'active' : '' }}"
        href="{{ route('send.mail.index') }}">{{ __('messages.send_mail.send_mail') }}</a>
    </li>
    ...
    <li
        class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('sadmin/send*','sadmin/list-mail*') ? 'd-none' : '' }}">
        <a class="nav-link p-0 {{ Request::is('sadmin/list-mail*') ? 'active' : '' }}"
            href="{{ route('list.mail.index') }}">{{ __('messages.send_mail.list_mail') }}</a>
    </li>
