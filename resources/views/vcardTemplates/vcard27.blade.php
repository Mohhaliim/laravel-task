                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-30 pb-60 px-30">
                        ...
                        <div class="appointment">
                            <div class="mb-30">
                                <label for="date"
                                    class="appoint-date text-black fs-18 mb-1">{{ __('messages.date') }} :</label>
                                <div class="row">
                                    <div class="col-12">
                            ...
                            <div class="">
                                <label class="text-black fs-18 mb-10">{{ __('messages.hour') }} :</label>
                                <div class="">
                        ...
                        <form action="" id="enquiryForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-30">
                                    <textarea class="form-control h-100" placeholder="Your Message" rows="3" name="message"></textarea>
                                </div>
            ...
            <div class="btn-section cursor-pointer">
                <div class="fixed-btn-section">
                    @if (empty($userSetting['hide_stickybar']))
                        <div class="bars-btn pet-shop-bars-btn">
