                    ...
                    <div class="mb-10 mt-0">
                        <div class="support-banner d-flex align-items-center justify-content-center">
                            ...
                            <div class="">
                                ...
                                <div class="text-center">
                                    <a href="{{ $banners->url }}" id="support-banner-btn" data-button-style="{{ isset($dynamicVcard) ? $dynamicVcard->button_style : 'default' }}" class="act-now rounded text-dark" target="blank"
