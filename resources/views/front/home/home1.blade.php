                    ...
                    <div class="">
                        <div class="pricing-card h-100">
                            <div class="text-center">
                                ...
                                <label class="fs-18 my-2 text-gray-100">{{ __('messages.plan.no_of_vcards') }}
                                    : {{ $plan->no_of_vcards }}</label><br>
                                <label class="fs-18 mb-3 text-gray-100">{{ __('messages.plan.storage_limit') }}
                            ...
                            <ul class="pricing-plan-list ps-xl-4 ps-lg-3 ps-md-4 ps-3 mb-60">
                                @foreach (collect(getPlanFeature($plan))->take(10) as $feature => $value)
                                ...
                                <div class="all-features d-none" style="display: none;">
                                    @foreach (collect(getPlanFeature($plan))->skip(10) as $feature => $value)
                                        <li class="{{ $value == 1 ? 'active-check' : 'unactive-check' }}">
                                            <span class="check-box">
                                                <i class="fa-solid {{ $value == 1 ? 'fa-check' : 'fa-xmark' }}"></i>
                                            </span>
